...
namespace _2014139598C.MVC.Controllers
{
    public class ProvinciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProvinciaId,nombreProvincia")] Provincia provincia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProvinciaId,nombreProvincia")] Provincia provincia)
        {
            if (ModelState.IsValid)
            {
