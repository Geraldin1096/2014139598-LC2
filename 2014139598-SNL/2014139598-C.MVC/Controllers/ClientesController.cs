...
namespace _2014139598C.MVC.Controllers
{
    public class ClientesController : Controller
    {
       // private LineaTelefonicaCDbContext db = new LineaTelefonicaCDbContext();
        ...
        public ActionResult Create([Bind(Include = "ClienteId,nombre,apPaterno,apMaterno,dni,sueldo,fecNacimiento")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ClienteId,nombre,apPaterno,apMaterno,dni,sueldo,fecNacimiento")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
